...
<head>
    <meta charset="UTF-8">
    <title>Ошибка - ${exception_code}</title>
    <meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'><link rel="stylesheet" href="../resources/css/exeption.scss">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <h2>Ой ОЙ! Технические шоколадки.</h2>
                <p>${exception_value}
                </p>
                <button class="btn green" onclick="goToHome()">Домой</button>
            </div>
        </div>
    </div>
</main>
<!-- partial -->
<script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.1.1/gsap.min.js'></script><script  src="../resources/js/exception.js"></script>
